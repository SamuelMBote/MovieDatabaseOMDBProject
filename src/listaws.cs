        private static List<EnderecoServico> CarregarEnderecosServicos()
        {
            ...
            //Rev: 09/09/2015
            //REV: 03/05/2022 - FELIPE, SEM ALTERAÇÕES
            #region Homologação
            foreach(var emissao in emissaoComum)
            {
                ...
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao2E3,
                    hom,
                    emissao,
                    Estado.AM,
                ...
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao2E3,
                    hom,
                    emissao,
                    Estado.AM,
                ...
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao2E3,
                    hom,
                    emissao,
                    Estado.AM,
                ...
                addServico(
                    new[] { ServicoNFe.NfeConsultaCadastro },
                    versao2E3,
                    hom,
                    emissao,
                    Estado.AM,
                ...
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao3,
                    hom,
                    emissao,
                    Estado.AM,
                ...
                addServico(
                    new[] { ServicoNFe.RecepcaoEventoCancelmento },
                    versao1,
                    hom,
                    emissao,
                    Estado.AM,
            ...
            //REV 03/05/2022 - FELIPE - SEM MUDANÇAS
            #region Homologação
            foreach(var emissao in emissaoComum)
            {
                #region NFe
            ...
            foreach(var emissao in emissaoComum)
            {
                if(emissao != TipoEmissao.teEPEC)
                    addServico(
                        ...
                        Estado.CE,
                        nfe,
                        ConfiguracaoUrls.FactoryUrl.Ceara.CartaCorrecaoCancelamentoHomologacao_VersaoUm);
                addServico(
                    new[] { ServicoNFe.NfeRecepcao },
                    versao2,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeRecepcaoHomologacao_VersaoDois);
                addServico(
                    new[] { ServicoNFe.NfeRetRecepcao },
                    versao2,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeRetRecepcaoHomologacao_VersaoDois);
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao2E3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeInutilizacaoHomologacao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao2E3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaProtocoloHomologacao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao2E3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeStatusServicoHomologacao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeConsultaCadastro },
                    versao2E3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaCadastroHomologacao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeDownloadNF },
                    versao2E3,
                    hom,
                    emissao,
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeDownloadNFHomologacao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NFeAutorizacao },
                    versao3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeAutorizacaoHomologacao_VersaoTres);
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao3,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeRetAutorizacaoHomologacao_VersaoTres);
                ...
                addServico(
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.CartaCorrecaoCancelamentoHomologacao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao4,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeInutilizacaoHomologacao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao4,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaProtocoloHomologacao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao4,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeStatusServicoHomologacao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NFeAutorizacao },
                    versao4,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeAutorizacaoHomologacao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao4,
                    hom,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeRetAutorizacaoHomologacao_VersaoQuatro);
            }
            #endregion
            ...
            foreach(var emissao in emissaoComum)
            {
                if(emissao != TipoEmissao.teEPEC)
                    addServico(
                        ...
                        Estado.CE,
                        nfe,
                        ConfiguracaoUrls.FactoryUrl.Ceara.CartaCorrecaoCancelamentoProducao_VersaoUm);
                addServico(
                    new[] { ServicoNFe.NfeRecepcao },
                    versao2,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeRecepcaoProducao_VersaoDois);
                addServico(
                    new[] { ServicoNFe.NfeRetRecepcao },
                    versao2,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeRetRecepcaoProducao_VersaoDois);
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao2E3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeInutilizacaoProducao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao2E3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaProtocoloProducao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao2E3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeStatusServicoProducao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeConsultaCadastro },
                    versao2E3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaCadastroProducao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NfeDownloadNF },
                    versao2E3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeDownloadNFProducao_VersaoDoisETres);
                addServico(
                    new[] { ServicoNFe.NFeAutorizacao },
                    versao3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeAutorizacaoProducao_VersaoTres);
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao3,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeRetAutorizacaoProducao_VersaoTres);
                ...
                addServico(
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeInutilizacaoProducao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaProtocoloProducao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeStatusServicoProducao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NfeConsultaCadastro },
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NfeConsultaCadastroProducao_VersaoQuatro);
                addServico(
                    eventoCceCanc,
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.CartaCorrecaoCancelamentoProducao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NFeAutorizacao },
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeAutorizacaoProducao_VersaoQuatro);
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao4,
                    prod,
                    ...
                    Estado.CE,
                    nfe,
                    ConfiguracaoUrls.FactoryUrl.Ceara.NFeRetAutorizacaoProducao_VersaoQuatro);
            }
            #endregion
            ...
            foreach(var emissao in emissaoComum)
            {
                ...
                foreach(var modelo in todosOsModelos)
                {
                    ...
                    addServico(
                        new[] { ServicoNFe.NfceAdministracaoCSC },
                        versao1,
                        hom,
                        emissao,
                        Estado.GO,
            ...
            foreach(var emissao in emissaoComum)
            {
                ...
                addServico(
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/NfeAutorizacao");
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao3,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/NfeRetAutorizacao");
                addServico(
                    new[] { ServicoNFe.NfeConsultaCadastro },
                    versao2,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.ms.gov.br/homologacao/services2/CadConsultaCadastro2");
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao2E3,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/NfeInutilizacao2");
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao2E3,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/NfeConsulta2");
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao2E3,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/NfeStatusServico2");
                addServico(
                    new[] { ServicoNFe.RecepcaoEventoCancelmento },
                    versao1,
                    hom,
                    ...
                    Estado.MS,
                    nfce,
                    "https://homologacao.nfce.fazenda.ms.gov.br/homologacao/services2/RecepcaoEvento");
            ...
            foreach(var emissao in emissaoComum)
            {
                ...
                addServico(
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/NfeAutorizacao");
                addServico(
                    new[] { ServicoNFe.NFeRetAutorizacao },
                    versao3,
                    prod,
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/NfeRetAutorizacao");
                addServico(
                    new[] { ServicoNFe.NfeInutilizacao },
                    versao2E3,
                    prod,
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/NfeInutilizacao2");
                addServico(
                    new[] { ServicoNFe.NfeConsultaProtocolo },
                    versao2E3,
                    prod,
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/NfeConsulta2");
                addServico(
                    new[] { ServicoNFe.NfeStatusServico },
                    versao2E3,
                    prod,
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/NfeStatusServico2");
                addServico(
                    new[] { ServicoNFe.RecepcaoEventoCancelmento },
                    versao1,
                    prod,
                    ...
                    Estado.MS,
                    nfce,
                    "https://nfce.fazenda.ms.gov.br/producao/services2/RecepcaoEvento");
                addServico(
                    new[] { ServicoNFe.NFeAutorizacao },
                    versao4,
                    prod,
            ...
            foreach(var emissao in emissaoComum)
            {
                ...
                if(emissao != TipoEmissao.teEPEC)
                    ...
                    addServico(
                        new[] { ServicoNFe.RecepcaoEventoEpec },
                        versao1,
                        hom,
                        emissao,
                        Estado.SP,
                ...
                foreach(var emissao in emissaoComum)
                {
                    foreach(var modelo in todosOsModelos)
                    {
                        addServico(
                            ...
                            estado,
                            modelo,
                            "https://cad-homologacao.svrs.rs.gov.br/ws/cadconsultacadastro/cadconsultacadastro2.asmx");
                    }
                }
            }
            #endregion
            ...
            foreach(var estado in todosOsEstados)
            {
                foreach(var modelo in todosOsModelos)
                {
                    ...
                    {
                        addServico(
                            new[] { ServicoNFe.RecepcaoEventoManifestacaoDestinatario },
                            versao1,
                            hom,
                            TipoEmissao.teNormal,
                            estado,
                    ...
                    if(modelo != ModeloDocumento.NFCe)
                        addServico(
                            new[] { ServicoNFe.NFeDistribuicaoDFe },
                            versao1,
                            hom,
                            TipoEmissao.teNormal,
                            estado,
